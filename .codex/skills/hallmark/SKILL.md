...
Most pages don't need it. The strongest hero is often a typographic one. **Reach for [`hero-enrichment.md`](references/hero-enrichment.md) only when the brief points there** - a SaaS / dev-tool brief wants a demo video or mockup; a bakery / caf / atelier brief wants a hand-built illustration; a manifesto wants nothing.
